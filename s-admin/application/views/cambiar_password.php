...
<body>
	...
	<div id="loginbox">
		<form id="passform" class="form-vertical">
			...
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><i class="icon-lock"></i></span><input id="contrasena_actual" name="contrasena_actual" type="password" placeholder="Contraseña Actual"
						 required />
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><i class="icon-lock"></i></span><input id="contrasena_nueva" name="contrasena_nueva" type="password" placeholder="Nueva Contraseña"
						 required />
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><i class="icon-lock"></i></span><input id="contrasena_nueva2" name="contrasena_nueva2" type="password" placeholder="Repite Nueva Contraseña"
						 required />
					</div>
				</div>
			</div>
			...
			<div class="form-actions">
				<span class="pull-right">
					<button id="btn_login" class="btn btn-success">Actualizar</button>
			</div>
		</form>
	</div>
