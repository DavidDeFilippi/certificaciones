			...
			<div class="row-fluid">
				<div class="span12">
					<div class="widget-content nopadding">
						<form id="frm-getReporte" class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select class="span5" id="tipo_reporte_cbx" name="tipo_reporte" required>
										<option value="">Seleccione</option>
										<option value="1">Inscritos por día programado (reservas)  por sesion</option>
										<option value="2">Resumen Gral por día y proceso completo</option>
										<option value="3">Lista de Clases diaria</option>
										<option value="4">Informe de avance de reservas por sede día y hora</option>
										<option value="5">INFORME GENERAL</option>
									</select>
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
									<button class="bt btn-success">Buscar Reporte</button>
								</div>
							</div>
						</form>
						<div id="out-reportes" class="widget-content">
